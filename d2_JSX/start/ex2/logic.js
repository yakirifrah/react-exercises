    ...
    render() {
        return (
            <div className="stripe-icon">
                <div onMouseEnter={this.props.onEnter} onMouseLeave={this.props.onLeave} className="icon1">
                </div>
                <TitleIcon1 />
                <SecondaryTitleIcon1 />
            </div>
...
class StripeIcon2 extends React.Component {
    render() {
        return (
            <div className="stripe-icon">
                <div onMouseEnter={this.props.onEnter} onMouseLeave={this.props.onLeave} className="icon2">
                </div>
                <TitleIcon2 />
                <SecondaryTitleIcon2 />
            </div>
...
class StripeIcon3 extends React.Component {
    render() {
        return (
            <div className="stripe-icon">
                <div onMouseEnter={this.props.onEnter} onMouseLeave={this.props.onLeave} className="icon3">
                </div>
                <TitleIcon3 />
                <SecondaryTitleIcon3 />
            </div>
